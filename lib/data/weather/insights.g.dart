...
WeatherInsightConfigV2 _$WeatherInsightConfigV2FromJson(
    ...
    WeatherInsightConfigV2(
      ...
      tempMinHot:
          Data<Temp>.fromJson(json['tempMinHot'] as Map<String, dynamic>),
      tempMinWarm:
          Data<Temp>.fromJson(json['tempMinWarm'] as Map<String, dynamic>),
      tempMinMild:
          Data<Temp>.fromJson(json['tempMinMild'] as Map<String, dynamic>),
      tempMinChilly:
          Data<Temp>.fromJson(json['tempMinChilly'] as Map<String, dynamic>),
      uvMinModerate:
          Data<UVIndex>.fromJson(json['uvMinModerate'] as Map<String, dynamic>),
      uvMinHigh:
          Data<UVIndex>.fromJson(json['uvMinHigh'] as Map<String, dynamic>),
      uvMinVeryHigh:
          Data<UVIndex>.fromJson(json['uvMinVeryHigh'] as Map<String, dynamic>),
    );
