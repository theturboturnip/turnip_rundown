...
WeatherDataBank _$WeatherDataBankFromJson(Map<String, dynamic> json) =>
    WeatherDataBank(
      ...
      uvIndex: DataSeries<UVIndex>.fromJson(
        json['uvIndex'] as Map<String, dynamic>,
      ),
    );
